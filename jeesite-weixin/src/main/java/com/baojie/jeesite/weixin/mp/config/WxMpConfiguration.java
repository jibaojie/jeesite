package com.baojie.jeesite.weixin.mp.config;

import com.baojie.jeesite.weixin.mp.handler.*;
...
public class WxMpConfiguration {
    ...
    @Autowired
    public WxMpConfiguration(MpLogHandler logHandler, MpNullHandler nullHandler, MpKfSessionHandler kfSessionHandler,
                             MpStoreCheckNotifyHandler storeCheckNotifyHandler, MpLocationHandler locationHandler,
                             MpMenuHandler menuHandler, MpMsgHandler msgHandler, MpUnsubscribeHandler unsubscribeHandler,
                             MpSubscribeHandler subscribeHandler, WxMpProperties properties) {
