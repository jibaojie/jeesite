...
public class BaseController<Biz extends BaseService, T> {
	...
	@ApiOperation(value = "新增")
 	public ResponseMessage<T> add(@RequestBody T t) {
		return Result.success((T) baseBiz.insertSelective(t));
	}
	...
	@ApiOperation(value = "逻辑删除， 传入isDel=1")
	public ResponseMessage<Integer> permanentDelete(@RequestBody T t) {
	...
	@ApiOperation(value = "删除")
 	public ResponseMessage<Integer> delete(@RequestBody T t) {
		return Result.success(baseBiz.updateSelectiveById(t));
    }
